      ...
      >
        <div className="flex flex-col items-center text-center max-w-full lg:max-w-[900px]">
          ...
          <div className="z-10 flex flex-wrap justify-center gap-4 mt-14">
            ...
            <button
              onClick={openModal}
              className="rounded-2xl h-12 px-10 border-2 bg-slate-700 border-slate-700 text-slate-100 font-medium transition hover:bg-transparent hover:text-slate-700 transform hover:scale-105 duration-200 ease-in-out"
            >
              Book Now
            </button>
          </div>
          ...
          <div className="flex justify-center space-x-7 mt-7 mr-2">
            <a
              href="https://www.facebook.com/profile.php?id=61569778173572"
